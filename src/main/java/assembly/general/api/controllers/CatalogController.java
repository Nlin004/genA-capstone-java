...
public class CatalogController {
    ...
    public PageResponse<BookSummaryResponse> list(
        ...
        return catalogService.list(page, size, sortBy, sortOrder, query, genre, isbn, availableOnly);
    }

    @GetMapping("/{bookId}")
    public BookDetailResponse get(@PathVariable UUID bookId) {
        return catalogService.get(bookId);
    }
}
