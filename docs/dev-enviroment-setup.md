...
- **HTTP**: `http://localhost:5099/api/HelloWorld`
...
Create sample data when your application starts: (This is a sample only)
...
**Solution:**
- Use HTTPS: `https://localhost:5001/swagger` (not HTTP)
...
- Always test using HTTPS (`https://localhost:5001`)
